...
Normally, I like to keep things conversational, but since this is a journey story I want to stick to the narrative and not get too far off-track. I hope you stick with me on this lighthearted journey to better software 😃
...
As a consultant part of the job is keeping up with technology trends and applying them to client solutions as needed. So, I try and remain curious and carve out time the best I can to better understand where I can apply them.

As a Solution Architect, finding pragmatic ways to apply methods, tools, and technologies is a constant driver in my work.

Recently, this led me down a learning path of finding ways to work with domain model "aggregates" and related ”building blocks" within microservices and event-driven architectures. I stumbled on this nice tutorial with all the tech buzzwords I was looking for in building a modern distributed system. It was a good start - but like with many tutorials what I learned quickly faded after going through it.

However, by adding color with a relatable story and using proven design methods, it has evolved into a well-designed, feature-rich Docker playground "system" that remains a powerful learning tool for ongoing experimentation and practice.

I want to share this "context to code" journey with you, today. I have applied many of these techniques and methods successfully on client engagements over the years and I have been mostly happy with the results.
...
From my perspective, the Order Mgmt subdomain is crucial. I want to ensure it scales to meet snackers' wishes and the lifecycle of a customer order does not impact receiving "wish commands". So I treat it as a "core subdomain" - meaning building custom software tailored to Sam's magic is the "way-to-go" (vs off-the-shelf or a basic CRUD app).
...
Sam is satisfied with the high level design and leaves me to deliver the work.
...
Adding "context to code" has helped my continuous learning journey allowing me to apply things I learn and build many enhancements beyond a "do and forget" tutorial.
...
Whether it is "Confluent Kafka" or "Redpanda" or recently "WarpStream by Confluent", I have verified I can swap out different stream processing engines without impacting the Snacks Unlimited Applications.
...
At the end of our journey, everyone lives happily every after. Brady, Oakley, and Rylan always get their snacks and are never sad. Mimi & Pop remain the best grandparents, and Sam is ready to spread snacks and joy around the world!!
